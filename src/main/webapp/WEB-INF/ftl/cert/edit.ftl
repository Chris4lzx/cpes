<div class="row">
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8">
		<h1 class="page-title txt-color-blueDark"> 修改资质信息</h1>
	</div>
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-4">
        <ul id="sparks" class="">
            <li class="sparks-info">
                <a style="margin-left: 10px;" class="btn btn-primary" href="#cert/index.htm">返回资质信息一览页面</a>
            </li>
        </ul>
    </div>
</div>
				...
				<div>
					...
					<div class="widget-body fuelux">
						<div class="step-content">
							...
							<form class="form-horizontal" id="certForm" method="post" >
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="fname" name="name" value="${ci.name}" style="border-left:none;" autocomplete="off">
												</div>
											</div>
										</div>
									</fieldset>
...
<script type="text/javascript">
	...
	function submitForm() {
	   ...
	   if ( fname == "" ) {
         ...
         $("#certForm").ajaxSubmit({
             type : "POST",
             url  : "${APP_PATH}/system/cert/update.do",
             ...
             success : function(r){
                 ...
                 if ( r.success ) {
                     layer.msg("资质信息修改成功", {time:2000, icon:1});
                 } else {
	...
	var pagefunction = function() {
		drawBreadCrumb( ["资质管理", "<a href='#cert/index.htm'>资质管理</a>", "修改资质信息"] );
	};
	pagefunction();
</script>
