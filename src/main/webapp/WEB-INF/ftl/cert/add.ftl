<div class="row">
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8">
		<h1 class="page-title txt-color-blueDark"> 新增资质信息</h1>
	</div>
...
<script type="text/javascript">
	...
	function submitForm() {
	   ...
	   if ( fname == "" ) {
         ...
         $("#certForm").ajaxSubmit({
             type : "POST",
             url  : "${APP_PATH}/system/cert/insert.do",
             ...
             success : function(r){
                 ...
                 if ( r.success ) {
                     layer.msg("资质信息增加成功", {time:2000, icon:1});
                 } else {
	...
	var pagefunction = function() {
		drawBreadCrumb( ["资质管理", "<a href='#cert/index.htm'>资质管理</a>", "新增资质信息"] );
	};
	pagefunction();
</script>
