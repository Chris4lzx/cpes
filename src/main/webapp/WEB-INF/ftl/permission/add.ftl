<div class="row">
	<div class="col-xs-8 col-sm-7 col-md-7 col-lg-8">
		<h1 class="page-title txt-color-blueDark"><i class="fa fa-plus fa-fw "></i> 新增</h1>
	</div>
					...
					<div class="widget-body fuelux">
						<div class="step-content">
							...
							<form class="form-horizontal" id="permissionForm" method="post">
								<input type="hidden" name="icon" id="fclassval" value="">
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="fname" autocomplete="off" name="name" style="border-left:none;">
												</div>
											</div>
										</div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    ...
                                                    <#if level == 1>
                                                    <span class="input-group-addon" style="color:red"><i class="glyphicon glyphicon-star"></i></span>
                                                    <input class="form-control" type="text" id="furl" autocomplete="off" name="url" style="border-left:none;">
                                                    <#else>
                                                    <input class="form-control" type="text" id="furl" autocomplete="off" name="url" >
                                                    </#if>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" name="seqno">
...
<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
    ...
    <div class="modal-footer" style="text-align: center;">
        <a href="javascript:;" class="btn btn-operation btn-success" onclick="submitForm()"><i class="fa fa-plus"></i>&nbsp;新增</a>
	...
	function submitForm() {
	   ...
	   if ( fname == "" ) {
         ...
         $("#permissionForm").ajaxSubmit({
             type : "POST",
             url  : "${APP_PATH}/system/permission/insert.do",
