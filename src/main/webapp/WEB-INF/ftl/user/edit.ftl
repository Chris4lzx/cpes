<div class="row">
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8">
		<h1 class="page-title txt-color-blueDark"> 修改用户信息</h1>
	</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="floginacct" name="loginacct" value="${user.loginacct}" style="border-left:none;" autocomplete="off">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-list-alt fa-fw"></i></span>
                                                    <span class="input-group-addon" style="color:red"><i class="glyphicon glyphicon-star"></i></span>
                                                    <input class="form-control" type="text" id="fname" name="name" value="${user.name}" style="border-left:none;" autocomplete="off">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-list-alt fa-fw"></i></span>
                                                    <span class="input-group-addon" style="color:red"><i class="glyphicon glyphicon-star"></i></span>
                                                    <input class="form-control" type="text" id="femail" name="email" value="${user.email}" style="border-left:none;" autocomplete="off">
												</div>
											</div>
										</div>
									</fieldset>
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-12" style="text-align:center;">
                                                <a href="javascript:;" class="btn btn-operation btn-success" onclick="submitForm()"><i class="fa fa-edit"></i>&nbsp;修改</a>
...
<script type="text/javascript">
	...
	function submitForm() {
	   ...
	   if ( femail == "" ) {
         ...
         $("#userForm").ajaxSubmit({
             type : "POST",
             url  : "${APP_PATH}/system/user/update.do",
             ...
             success : function(r){
                 ...
                 if ( r.success ) {
                     layer.msg("用户信息修改成功", {time:2000, icon:1});
                 } else {
	...
	var pagefunction = function() {
		drawBreadCrumb( ["权限管理", "<a href='#user/index.htm'>用户管理</a>", "修改用户信息"] );
	};
	pagefunction();
</script>
